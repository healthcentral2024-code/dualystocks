...
const dict = {
  ...
  optionsTitle: { es: "Contexto histórico para CALL y PUT", en: "Historical CALL and PUT context" },
  optionsSubtitle: {
    es: "Compara la dirección y el movimiento reciente de la acción para el plazo elegido.",
    en: "Compare the stock's recent direction and movement for the selected time frame.",
  },
  optionsWeek: { es: "1 semana", en: "1 week" },
  optionsTwoWeeks: { es: "2 semanas", en: "2 weeks" },
  optionsMonth: { es: "1 mes", en: "1 month" },
  optionsExpectedRange: { es: "Rango histórico estimado", en: "Estimated historical range" },
  optionsTypicalMove: { es: "Movimiento típico", en: "Typical move" },
  optionsHistoricalVolatility: { es: "Volatilidad realizada", en: "Realized volatility" },
  optionsVolatilityPercentile: { es: "Percentil histórico:", en: "Historical percentile:" },
  optionsCall: { es: "CALL", en: "CALL" },
  optionsPut: { es: "PUT", en: "PUT" },
  optionsFavorable: { es: "Condiciones favorables", en: "Favorable conditions" },
  optionsUnfavorable: { es: "Condiciones poco favorables", en: "Less favorable conditions" },
  optionsHistoricalScore: { es: "Puntuación histórica", en: "Historical score" },
  optionsInsufficient: {
    es: "No hay suficientes sesiones recientes para calcular una orientación responsable.",
    en: "There are not enough recent sessions to calculate a responsible outlook.",
  },
  optionsDisclaimer: {
    es: "Este semáforo evalúa únicamente el comportamiento histórico de la acción. No conoce la prima, el strike, el vencimiento, la volatilidad implícita ni las griegas de un contrato real; por eso no indica que una opción esté barata o cara y no es una recomendación.",
    en: "This signal evaluates only the stock's historical behavior. It does not know a real contract's premium, strike, expiration, implied volatility, or Greeks; therefore it does not say an option is cheap or expensive and is not a recommendation.",
  },
  optionsReasonBullishTrend: { es: "La tendencia de fondo es alcista.", en: "The underlying trend is bullish." },
  optionsReasonBearishTrend: { es: "La tendencia de fondo es bajista.", en: "The underlying trend is bearish." },
  optionsReasonSidewaysTrend: { es: "La tendencia está lateral y no favorece una dirección clara.", en: "The trend is sideways and does not favor a clear direction." },
  optionsReasonRsiOverbought: { es: "El RSI está sobrecomprado; aumenta el riesgo de retroceso.", en: "RSI is overbought, increasing pullback risk." },
  optionsReasonRsiOversold: { es: "El RSI está sobrevendido; aumenta la posibilidad de rebote.", en: "RSI is oversold, increasing rebound potential." },
  optionsReasonRsiBalanced: { es: "El RSI está en una zona equilibrada.", en: "RSI is in a balanced zone." },
  optionsReasonRoomResistance: { es: "Hay espacio histórico suficiente antes de la resistencia.", en: "There is enough historical room before resistance." },
  optionsReasonLimitedResistance: { es: "La resistencia está cerca frente al movimiento esperado.", en: "Resistance is close relative to the expected move." },
  optionsReasonRoomSupport: { es: "Hay espacio histórico suficiente antes del soporte.", en: "There is enough historical room before support." },
  optionsReasonLimitedSupport: { es: "El soporte está cerca frente al movimiento esperado.", en: "Support is close relative to the expected move." },
  optionsReasonHighVolatility: { es: "El movimiento reciente está elevado frente a su propio historial.", en: "Recent movement is elevated versus its own history." },
  optionsReasonNormalVolatility: { es: "El movimiento reciente está dentro de su comportamiento histórico normal.", en: "Recent movement is within its normal historical behavior." },
  inviteRewardNote: {
  ...
  calcTitle: { es: "Calculadora de operación a corto plazo", en: "Short-term trade calculator" },
  calcSubtitle: { es: "Calcula tu escenario si decides comprar hoy. Usa acciones enteras y no incluye comisiones, impuestos ni deslizamiento. El resultado no está garantizado y no es una recomendación.", en: "Calculate your scenario if you decide to buy today. It uses whole shares and excludes fees, taxes, and slippage. Results are not guaranteed and this is not a recommendation." },
  calcInvestment: { es: "Inversión total ($)", en: "Total investment ($)" },
  calcEntryPrice: { es: "Precio de entrada ($)", en: "Entry price ($)" },
  calcTargetPrice: { es: "Precio de venta objetivo ($)", en: "Target sale price ($)" },
  calcStopLoss: { es: "Precio de stop-loss (opcional) ($)", en: "Stop-loss price (optional) ($)" },
  calcStopLossPlaceholder: { es: "Ej. 145,50", en: "E.g. 145.50" },
  calcShares: { es: "Acciones enteras", en: "Whole shares" },
  calcCashLeft: { es: "Efectivo sobrante", en: "Cash left over" },
  calcProfitPerShare: { es: "Ganancia por acción", en: "Profit per share" },
  calcTotalProfit: { es: "Ganancia potencial total", en: "Total potential profit" },
  calcFinalValue: { es: "Valor final estimado", en: "Estimated final value" },
  calcReturn: { es: "Retorno potencial", en: "Potential return" },
  calcLossPerShare: { es: "Pérdida por acción", en: "Loss per share" },
  calcTotalLoss: { es: "Pérdida total", en: "Total loss" },
  calcLossPercent: { es: "Riesgo de pérdida", en: "Loss risk" },
  calcRewardRisk: { es: "Relación ganancia/riesgo", en: "Reward/Risk ratio" },
  calcInvalid: { es: "Los valores deben ser mayores a cero. El precio objetivo debe ser mayor que el precio de entrada.", en: "Values must be greater than zero. Target price must be greater than entry price." },
  calcInsufficientFunds: { es: "La inversión indicada no alcanza para comprar una acción completa al precio de entrada.", en: "The investment amount is not enough to buy one whole share at the entry price." },
  calcInvalidStopLoss: { es: "El precio de stop-loss debe ser menor que el precio de entrada.", en: "Stop-loss price must be less than entry price." },
  calcGoodOutcome: { es: "Si la operación sale bien", en: "If trade goes well" },
  calcBadOutcome: { es: "Si salta el stop-loss", en: "If stop-loss hits" },
  calcAddStopLoss: { es: "Agrega un precio de stop-loss para ver tu riesgo y el ratio riesgo/beneficio.", en: "Add a stop-loss price to see your risk and reward/risk ratio." },
  calcTabSingle: { es: "Una acción", en: "Single stock" },
  calcTabCompare: { es: "Comparar escenarios", en: "Compare scenarios" },
  calcCompareAddTicker: { es: "Añadir símbolo", en: "Add symbol" },
  calcComparePlaceholder: { es: "Ej. GOOGL", en: "E.g. GOOGL" },
  calcCompareAdd: { es: "Añadir", en: "Add" },
  calcCompareMaxReached: { es: "Máximo 5 acciones", en: "Maximum 5 stocks" },
  calcCompareInvalid: { es: "El formato del símbolo no es válido.", en: "The symbol format is not valid." },
  calcCompareDuplicate: { es: "Esta acción ya está en la comparación.", en: "This stock is already in the comparison." },
  calcCompareEmpty: { es: "Añade acciones para comparar", en: "Add stocks to compare" },
  calcCompareHighest: { es: "Mayor ganancia potencial", en: "Highest potential profit" },
  calcCompareProfit: { es: "Ganancia:", en: "Profit:" },
  calcCompareTarget: { es: "Venta:", en: "Target:" },
  calcCompareShares: { es: "Acciones:", en: "Shares:" },
  calcComparePerShare: { es: "por acción", en: "per share" },
  calcCompareGlobalInvestment: { es: "Inversión a comparar ($)", en: "Investment to compare ($)" },
  calcCompareHelp: { es: "Se simula invertir el mismo monto en cada acción de forma independiente para ver cuál rendiría mejor.", en: "We simulate investing the same amount in each stock independently to see which would perform better." },
  calcCompareRemove: { es: "Quitar", en: "Remove" },
  calcCompareLoading: { es: "Cargando precio...", en: "Loading price..." },
  calcCompareError: { es: "Error de carga", en: "Load error" },
  calcCompareFinalValue: { es: "Valor final:", en: "Final value:" },
  calcCompareRank: { es: "Rango", en: "Rank" },
} as const;
